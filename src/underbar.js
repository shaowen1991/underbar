(function() {
  ...
  _.last = function(array, n) {
    var firstIndex = n > array.length ? 0 : array.length - n;
    return n === undefined ? array[array.length-1] : array.slice(firstIndex, array.length);
  };
  ...
  _.map = function(collection, iterator) {
    ...
    if (Array.isArray(collection)) {
      ...
      for (var key in collection) {
        result[key] = iterator(key,collection[key],collection);
      }
    }
    return result;
  };
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      if (!argument.hasOwnProperty(args)) {
        result = func.apply(this, arguments);
        argument[args] = result;
        return result;
      }
